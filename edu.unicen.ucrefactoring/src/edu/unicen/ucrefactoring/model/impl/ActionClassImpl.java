 ...
 * <ul>
 *   <li>{@link edu.unicen.ucrefactoring.model.impl.ActionClassImpl#getClassName <em>Class Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActionClassImpl extends EObjectImpl implements ActionClass {
	...
	public void setClassName(String newClassName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, UCRefactoringPackage.ACTION_CLASS__CLASS_NAME, oldClassName, className));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case UCRefactoringPackage.ACTION_CLASS__CLASS_NAME:
				return getClassName();
		}
